...
<hr >
 ...
 <?php if(isset($employee_data1['0']['Emp_fname']) && isset($employee_data1['0']['Emp_lname'])) { echo $employee_data1['0']['Emp_fname'].' '.$employee_data1['0']['Emp_lname']; }?> has approved your goalsheet for the current financial year.<br/>

<span> Please login to <a href="http://52.172.210.251/kritvapms/index.php/Login">PMS Login</a> to check.</span>
