        ...
        j(".date_pickup").attr('onkeydown','return false');  
                    ...
                    $("body").on('click','.del_kpi',function(){
                        ...
                        $("#del_goal_set").click(function(){
                            ...
                            datatype : 'html',
                            data : data,
                            url : base_url+'/kritvapms/index.php?r=Setgoals1/kpi_del',
                            success : function(data)
                            {
                ...
                $(window).scroll(function()
                {
                    ...
                    $('body').on('keyup','.value_field',function(e){
                                       ...
                                       console.log(selected_unit1);
                                        ...
                                        if ($.isNumeric(data_value)) {
                                           $.ajax({
                                            ...
                                            datatype : 'html',
                                            data : selected_unit1,
                                            url : base_url+'/kritvapms/index.php?r=Setgoals1/fetch_field',
                                            success : function(data)
                                            {
                                                var res = data.split(","); 
                                ...
                                $('body').on('keypress','.kpi_list',function(event){
                                            ...
                                            datatype : 'html',
                                            data : kpi_value,
                                            url : base_url+'/kritvapms/index.php?r=Setgoals1/kpi_list',
                                            success : function(data)
                                            {
                                                if (data != '') 
                                                {
                        ...
                        if(error == '')
                    {
                        ...
                        else
                        {
                            $.ajax({
                                ...
                                datatype : 'html',
                                data : data,
                                url : base_url+'/kritvapms/index.php?r=Setgoals1/update_kpi',
                                success : function(data)
                                {                                   
                                    if (data == "success")
                                    {
                    ...
                    else if(!kpi_total_number < kpi_list_data)
                    {
                        ...
                        var base_url = window.location.origin;
                            ...
                            $.ajax({
                                ...
                                datatype : 'html',
                                data : data,
                                url : base_url+'/kritvapms/index.php?r=Setgoals1/save_kpi',
                                success : function(data)
                                {
                                    // if (data != '') 
                                    // {
                        ...
                        if(error != '')
                        {
                         ...
                         { 
                            ...
                            $.ajax({
                                ...
                                datatype : 'html',
                                data : data,
                                url : base_url+'/kritvapms/index.php?r=Setgoals1/savekpi',
                                success : function(data)
                                {
                                    //alert(data);
                                    if (data == "Success")
                                                        ...
                                                        $("#show_spin").show();
                                                         var base_url = window.location.origin;
                                                            $.ajax({
                                                                type : 'post',
                                                                datatype : 'html',
                                                                url : base_url+'/kritvapms/index.php?r=Setgoals1/sendmail',
                                                                success : function(data)
                                                                {
                                                                    //alert(data);
                                                                    $("#show_spin").hide(); 
                ...
                function get_target_value()
                {
                    ...
                    var base_url = window.location.origin;
                     $.ajax({
                            ...
                            datatype : 'json',
                            data : selected_unit,
                            url : base_url+'/kritvapms/index.php?r=Setgoals1/gettarget_value',
                            success : function(data)
                            { 
                                //alert(detail[2]);
