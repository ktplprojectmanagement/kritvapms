...
<?php
 ...
 if(Yii::app()->user->getState("employee_email") == "amit.sanas@vvfltd.com" || Yii::app()->user->getState("employee_email") == "jayesh.menon@kritva.com")
        {
...
<td id="qualrate-<?php echo $cnt; ?>"><?php if(isset($row['reporting_1_change']) && isset($IDPForm_data[$cnt]['0']['manager_1_rate']) && isset($IDPForm_data[$cnt]['0']['manager_2_rate']) && $row['reporting_1_change'] != ''){ echo $IDPForm_data[$cnt]['0']['manager_1_rate']+$IDPForm_data[$cnt]['0']['manager_2_rate']; }else if(isset($IDPForm_data[$cnt]['0']['performance_rating'])) { echo $IDPForm_data[$cnt]['0']['performance_rating']; }  ?></td>
<td><?php if(isset($IDPForm_data[$cnt]['0']['Tota_score']) && $IDPForm_data[$cnt]['0']['Tota_score']!=''){ echo $IDPForm_data[$cnt]['0']['Tota_score']; } ?></td>
<td><?php if(isset($row['reporting_1_change']) && (isset($IDPForm_data[$cnt]['0']['manager_1_rate']) && isset($IDPForm_data[$cnt]['0']['manager_2_rate'])) && $row['reporting_1_change'] != ''){ echo round($IDPForm_data[$cnt]['0']['manager_1_rate']+$IDPForm_data[$cnt]['0']['manager_2_rate']); }else if(isset($IDPForm_data[$cnt]['0']['performance_rating'])) { echo round($IDPForm_data[$cnt]['0']['performance_rating']); } ?></td>
<?php if((Yii::app()->user->getState("employee_email") == 'amit.sanas@vvfltd.com') ||  (isset($is_bu) && count($is_bu)>0)) { ?>
...
else if($("#specific_user").text() == "jayesh.menon@kritva.com")
{
     if($("#search-clustername").val() == 'CMB Manufacturing')
    {
        initial_index = 0;
