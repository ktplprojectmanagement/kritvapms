...
function save_final_year_data1()
{
                           ...
                           //alert("dfgdfgfd");
                            //   alert($('#yearA_prj_stat_comments').val()); 
                                   ...
                                   formData.append("Year_end_prog_comments",$('#yearA_prj_stat_comments').val());
                                    ...
                                    $.ajax({
                                        type : 'post',
                                            ...
                                            data : formData,
                                            url : base_url+'/kritvapms/index.php/Year_endreview11/updatereview1',
                                            success : function(data)
                                            {
//alert(data);
                                          //    jQuery("#static_saved").modal('show');
$("#err").show();  
...
<link href="https://vvf.kritva.in/css/progress-wizard.min.css" rel="stylesheet">
                                                                  ...
                                                                  if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{
                                                               ...
                                                               if ($kpi_unit[$i] == 'Date') {
                                                                 echo CHtml::textField('emp_actual_achieve',$year_end_achieve[$i],array('class'=>'form-control date_show valid_entry1','id'=>'emp_actual_achieve-'.$i.$kpi_data[$k]['KPI_id'],'disabled'=> $view_flag,'data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom","maxlength"=>"1000"));
                                                               }
                                                               else
                                                               {
                                                                 echo CHtml::textArea('emp_actual_achieve',$year_end_achieve[$i],array('class'=>'form-control valid_entry validate_field valid_entry1','id'=>'emp_actual_achieve-'.$i.$kpi_data[$k]['KPI_id'],'disabled'=> $view_flag,'data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom","maxlength"=>"1000"));
                                                            ...
                                                            else
                                                            {
                                                               ...
                                                               else
                                                               {
                                                                   ...
                                                                   echo CHtml::textArea('emp_actual_achieve',$year_end_achieve[$i],array('class'=>'form-control valid_entry validate_field valid_entry1','id'=>'emp_actual_achieve-'.$i.$kpi_data[$k]['KPI_id'],'data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom","maxlength"=>"1000"));
                                                               }
                                                            ...
                                                            if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{
                                                               echo CHtml::textArea('appraisee_comment',$year_end_reviewa[$i],array('class'=>'form-control validate_field','id'=>'appraisee_comment'.$i.$kpi_data[$k]['KPI_id'],'disabled'=> $view_flag,'data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom","maxlength"=>"1000"));
                                                            }
                                                            else
                                                            {
...
?>
<!--  -->                                    
<a id='<?php echo "del_file_name-".$i."-".$kpi_data[$k]['KPI_id']; ?>' href='<?php echo Yii::app()->request->baseUrl; ?>/data(proof)/<?php echo $doc_prf_by_emp[$f]; ?>' target="_blank" download><?php echo $doc_prf_by_emp[$f]; ?></a>
...
<?php  ?>
<?php }
else if($seq_number[$f] != $kpi_data[$k]['KPI_id'].$i)
{
$num++;
}
 } ?>
                                           ...
                                           if (isset($IDP_data['0']['Year_end_prg_status']) && $IDP_data['0']['Year_end_prg_status'] != '') 
                                            {
                                              ...
                                              $year_program_cmnt = explode('^',$IDP_data['0']['Year_end_prg_comments']);
                                                if (isset($year_program_cmnt[$state])) {
...
$prg_list = $prg_list.';'.$i;
                    ...
                    <td><div id="yearAcompleteion_type_sta<?php echo $i; ?>"> <input type="radio" name='yearAcompleteion_type1<?php echo $i; ?>' <?php if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{ ?>disabled="true"<?php } ?> value="Yes" id='yearAcompleteion_type<?php echo $i; ?>' class='yearAcompleteion_type<?php echo $i; ?>  yearA_comp' <?php if($year_program_state1 == 'Yes') { ?>checked='check'<?php } ?>>Yes
...
{ ?>disabled="true"<?php } ?> name='yearAcompleteion_type1<?php echo $i; ?>' value="No" id='yearAcompleteion_type<?php echo $i; ?>' class='yearAcompleteion_type<?php echo $i; ?> yearA_comp' <?php if($year_program_state1 == 'No') { ?>checked='check'<?php } ?>>No
                            ...
                            $(window).scroll(function()
                            {
                             ...
                             var base_url = window.location.origin;
                              $.ajax({
                                  ...
                                  datatype : 'html',
                                  data : emp_id,
                                  url : base_url+'/kritvapms/index.php/Year_endreview11/final_goal_review',
                                  success : function(data)
                                  {
                                          ...
                                          $("#continue_goal_set").click(function(){
                                              $("#show_spin").show();
                                                  $.ajax({
                                                      type : 'post',
                                                      datatype : 'html',
                                                      url : base_url+'/kritvapms/index.php/Year_endreview11/goalnotification1',
                                                      success : function(data)
                                                      {
...
error = "Please select program status";
    ...
    $("#yearAcompleteion_type"+i+':checked').css('border','2px solid red');
     $("#yearAcompleteion_type"+i).focus();break;
}
    ...
    $("#yearAprogram_cmd-"+i).focus();break;
}
...
for (var i = 0; i < ext_list_data.length; i++) { 
 ...
 if($("#topic"+i).val()!="" && $(".yearAextraprg_"+ext_list_data[i]+':checked').val()=="No" && ($("#yearAextraprogram_cmt-"+ext_list_data[i]).val() == '' || $("#yearAextraprogram_cmt-"+ext_list_data[i]).val() === undefined)){
    ...
    $("#yearAextraprogram_cmt-"+ext_list_data[i]).focus();break;
}
...
error = "Please select extra program status";
    ...
    $(".yearAextraprg_"+ext_list_data[i]+':checked').css('border','2px solid red');
     $(".yearAextraprg_"+ext_list_data[i]).focus();break;
}
else
{
error3 = "";
...
error = "Please select relationship program status";
    error3 = "error";
     ...
     $("#yearArel_program_review"+i).focus();break;
}
                                   ...
                                   formData.append("Year_end_prog_comments",$('#yearA_prj_stat_comments').val());
                                    ...
                                    $.ajax({
                                        type : 'post',
                                            ...
                                            enctype : 'multipart/form-data',
                                            data : formData,
                                            url : base_url+'/kritvapms/index.php/Year_endreview11/updatereview',
                                            success : function(data)
                                            {
                                              jQuery("#static").modal('show');
                                          $("#continue_goal_set").click(function(){
...
var base_url = window.location.origin;
                                    $.ajax({
                                        type : 'post',
                                            datatype : 'html',
                                            data : data,
                                            url : base_url+'/kritvapms/index.php/Year_endreview11/updatereview_delfile1',
                                            success : function(data)
                                            {
 ...
 var base_url = window.location.origin;
                                    $.ajax({
                                        type : 'post',
                                            datatype : 'html',
                                            data : data,
                                            url : base_url+'/kritvapms/index.php/Year_endreview11/updatereview_delfile',
                                            success : function(data)
                                            {
...
<div>
   ...
   <h6><b>Rating Of Qualitative Goals</b></h6>
    ...
    <table>
        ...
        <tr ><td style="border: 1px solid #00000a; padding-top: 6px; padding-bottom: 6px; padding-left: 0.2cm; padding-right: 0.19cm;margin-top: 0px;"><b>Answer:-</b><?php  if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{
