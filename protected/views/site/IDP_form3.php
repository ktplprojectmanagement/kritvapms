            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content"> 
                         <div class="modal-body">
                                    <p> IDP Mid Review updation done successfully. </p>
                                </div>
                                <div class="modal-footer">
                                <a href="<?php echo Yii::app()->request->baseUrl; ?>/pmsuser/index.php?r=IDP/IDP_Mid_approvegoal_list"><button type="button" class="btn border-blue-soft" id="redirect_to_master">Master Page</button></a>
                                </div> 
                        </div>
                    </div>
                   </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p> Are you sure you want to approve <?php if(isset($emp_data['0']['Emp_fname'])) { echo $emp_data['0']['Emp_fname']." ".$emp_data['0']['Emp_lname']."'"; } ?>  Midreview of IDP? </p>
                                </div>
                                <div class="modal-footer">
...
<span class="caption-subject  bold uppercase" style="color:white;font-size: 12px;">Part A: Development through Instructor led training in Classroom</span><br>
                                    ...
                                    if (isset($program_data_result) && count($program_data_result)>0) {
                                        for ($i=1; $i < count($program_data_result); $i++) {
...
$rel_prgrm_cmd2 = '';
                                                    ...
                                                    <div class="form-group">
                                                      <div class="col-md-12">
                                                        <label class="col-md-12 control-label" style="text-align:left;color:#337ab7;">
                                                          <span class="bold">Part C: Development through action learning projects
                                                        </span></label>
                                                      </div>
                                                ...
                                                <div class="form-group last">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group input-medium date date-picker review_date" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                         <?php
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="input-group input-medium date date-picker target_end_date" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                                <?php
                                                ...
                                                <div class="form-group last">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        echo CHtml::textField('project_scope',$project_scope,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 project_scope",'disabled'=> "true")); ?> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group last">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        echo CHtml::textField('project_exclusion',$project_exclusion,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 project_exclusion",'disabled'=> "true")); ?> 
                                                    </div>
                                                </div>                                                
                                                <div class="form-group">
                                            ...
                                            <form action="#" id="form-username" class="form-horizontal form-bordered">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        echo CHtml::textArea('deliverables',$Project_deliverables,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 project_deliverables",'style'=>'max-width: 827px;width: 936px;height: 214px;max-height: 67px;','disabled'=> "true")); ?> 
                                                    </div>
                                                </div>
                                                <div class="form-group last">
                                                    ...
                                                    <div class="col-md-9">
                                                       ...
                                                       echo CHtml::textArea('exp',$expected,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 learn_from",'disabled'=> "true")); ?>  
                                                    </div>
                                                </div>
             ...
             $(function(){
              $("body").on('click','.add_program',function(){
                ...
                $(".send_for_appraisal1").click(function(){
                    var chk_cmnts = 0;var chk_cmnts1 = 0;var chk_cmnts2 = 0;var chk_cmnts3 = 0;var program_status = '';var extra_program_status = '';
                    ...
                    if (chk_cmnts == 0 || chk_cmnts<$("#program_count").text()) 
                    {
                      //alert(chk_cmnts);
                         $('body').animate({
                            scrollTop: ( $("#maintable").first().offset().top)
                        },500);
                    ...
                    {
                         $('body').animate({
                            scrollTop: ( $("#error_spec1").first().offset().top)
                        },500);
                    ...
                    else if ($("#compare_designation").text() == 1 && ($(".project_mid_review").val() === undefined || $(".project_mid_review").val() == '')) 
                    {
                      ...
                      $(".project_mid_review").css('border-color','red');
                         $('body').animate({
                          ...
                          $("#error_spec4").text("Please fill the mid review for Development through action learning projects(Note : Maximum 500 characters are allowed).");                          
                    }                             
                    else
                    {
                      $(".project_mid_status").css('border-color','');
                               ...
                               if (data) 
                                {
                                    $("#err").show();  
                                    $("#err").fadeOut(6000);
                                    $("#err").text("Successfully IDP Submitted");
                                    ...
                                    {
                                      //alert($(".send_for_appraisal1").attr('id'));
                                        var data = {
