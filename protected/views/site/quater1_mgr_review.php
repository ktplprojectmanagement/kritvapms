...
$(document).ready(function(){
    ...
    for (var j = 0; j < $("#total_kra_number").text(); j++) {
        for (var i = 0; i < $("#get_kpi_count-"+id[j]).text(); i++) { 
            if($(".review_comment"+id[j]+i).val()=='' || $(".review_comment"+id[j]+i).val() == "undefined"){
                $(".review_comment"+id[j]+i).text("NA");
            }
           //  alert(i);
        }
    }
...
mgr_cmt3=$('.mgr_cmt3').val();
                          var data = {
                                        ...
                                        'q1_mgr_cmt1': mgr_cmt1,
                                        'q1_mgr_cmt2': mgr_cmt2,
...
//alert(chk_cmnts);
                    ...
                    for (var i = 0; i < 2; i++) {
                     if (rel_program_review_status == '') 
                        {
                           rel_program_review_status = $("#rel_prg_status_mgr-"+i+" option:selected").text();
                        }
                        else
                        {
                          rel_program_review_status = rel_program_review_status+';'+$("#rel_prg_status_mgr-"+i+" option:selected").text();
                        }
                      }
                     //alert(rel_program_review_status);
                      var base_url = window.location.origin;
...
//   $IDP_data = $IDPForm->get_idp_data($where,$data,$list);
		$where = 'where Employee_id = :Employee_id AND goal_set_year= :goal_set_year';
			...
			$data = array(Yii::app()->user->getState('emp_id_3'),'2017-2018');
			$IDP_data = $IDPForm->get_idp_data($where,$data,$list);
                ...
                <div class="page-head">
                    <div class="container">
                        ...
                        <div class="page-title">
                            <h1>Quaterly Review</h1>
                        </div>
                         <h4 style="float: right;"><?php if(isset($employee_data['0']['Emp_fname']) && isset($employee_data['0']['Emp_lname'])) { echo 'Employee Name : '.$employee_data['0']['Emp_fname']." ".$employee_data['0']['Emp_lname'].' / '; } ?>
                    ...
                    $("body").on('keyup','.validate_field',function(){
                       var chk = /[;]/;
                        if (chk.test($(this).val())) 
                        {
                            ...
                            $("#err").text("Quater1 review text should not contain special characters like ;");
                        }
                        else if ($(this).val().length>500) 
                        {
                            ...
                            $("#err").addClass("alert-danger"); 
                            $(this).css('border','1px solid red');
                            $("#err").text("Quater1 review should contain maximum 500 characters.");
                        }
                        else
                        {
                    ...
                    <div class="page-content-container">
                        <div class="page-content-row">
                            ...
                            <div id="err" style="display: none"></div>
                             <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Quater1"><?php echo CHtml::button('Back',array('class'=>'btn border-blue-soft','style'=>'float:right;margin-right: 13px;')); ?></a><br><br>
                                <!-- BEGIN PAGE BASE CONTENT -->                                
                                 <!-- BEGIN SAMPLE TABLE PORTLET-->
                                        ...
                                        <?php    if (isset($kpi_data) && count($kpi_data)>0) { $cnt1 = 0;
                                               ...
                                               <label id="total_kra_number" style="display: none"><?php if(isset($kpi_data)) { echo count($kpi_data); } ?></label>
                                            <?php
...
<tr>
                                                ...
                                                <td align="left" valign=middle><b><font face="Calibri" size=3>Quater 1 review status by Employee</font></b></td>
<td align="left" valign=middle ><b><font face="Calibri" size=3>Employee Comments</font></b></td>
                                                <td align="left" valign=middle ><b><font face="Calibri" size=3>Quater 1 Review Status</font></b></td>
                                                <td align="left" valign=middle ><b><font face="Calibri" size=3>Quater 1 Review Comments</font></b></td>
                                                   ...
                                                   <?php
                                                                ...
                                                                $appr_status1 = explode(';',$row['q1_emp_status']);
                                                           ...
                                                           <?php
                                                                $cnt = 0;
                                                                for ($i=0; $i < count($kpi_list_data); $i++) { if (isset($kpi_list_unit[$i]) && $kpi_list_unit[$i]!='Select') { $cnt++;
                                                            ?>
                                                                <style type="text/css">
                .popover{
   min-width:30px;
   ...
   border:1px solid #4c87b9;
                                                                ...
                                                                <tr id="review_state-<?php echo $row['KPI_id'].$i?>">
                                                                    <td><lable data-toggle="popover" data-trigger="hover" data-placement="bottom" data-content="<?php if(isset($kpi_list_data[$i])) { echo $kpi_list_data[$i];echo""; } ?>"><?php echo strlen($kpi_list_data[$i]) >= 20 ? 
                                                                        ...
                                                                        ?>
                                                                               ...
                                                                               <tr>
                                                                                 ...
                                                                                 <tr>
                                                                                   ...
                                                                                   <tr>                                                                    
                                                                              <?php
                                                                               for ($l=0; $l < count($value_data); $l++) { if(isset($value_data[$l])) { ?>
                                        ...
                                        for ($i=0; $i < count($program_data_result); $i++) {    
                                         ...
                                         $cmnt = '';
                                            ...
                                            if (isset($IDP_data['0']['q1_prgrm_cmd'])) 
                                            {
                                              ...
                                              if(isset($IDP_data['0']['q1_prgrm_cmd']))
                                              {
                                                 $program_cmnt = explode(';',$IDP_data['0']['q1_prgrm_cmd']);
                                              }
 ...
 echo CHtml::dropDownList("tot_prog_status_emp-".$i,'',$review_type,$htmlOptions=array('disabled' => 'disabled','class'=>"form-control tot_prog_status_emp-".$i,'style'=>"width: 186px;",'options' => $status));
                                                ...
                                                <td>
                                                  ...
                                                  else
                                                  {
                                                    ...
                                                    echo CHtml::textField('program_review_by_emp',$program_review_by_emp,$htmlOptions=array('disabled' => 'disabled','maxlength'=>80,'class'=>"form-control col-md-4 program_review_by_emp",'id'=>'program_review_by_emp-'.$i));
                                                ?>
                                                </td>       
                                          <td>
                                                    <?php 
                                                  // print_r($IDP_data);die();
                                                    if($IDP_data['0']['q1_mgr_trn_prog_stat'])
                                                    {
                                                 ...
                                                 $rel_program_review_by_emp = '';$rel_program_emp_cmd1 = '';
                                                    if (isset($count) && $count !='' && count($count)>0) {
                                                      for ($m=0; $m < count($count); $m++) {  
                                                        ...
                                                        $rel_program_status2 = explode(';',$IDP_data['0']['q1_rel_prog_cmt_mgr']);
                                                    ...
                                                    ?>
                                                      <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                        <textarea class="form-control col-md-4" disabled="disabled"><?php if(isset($extra_program_review_by_emp0)) { echo $extra_program_review_by_emp0; } ?></textarea>
                                                        </div>
                                                        <div  class="col-md-2 " id="extra<?php echo $m; ?>" >
<?php
if(isset($IDP_data['0']['midyear_status_flag']) && count($IDP_data)>0 && $IDP_data['0']['midyear_status_flag']=='Approved') {
?>
...
?>
                                                        ...
                                                        <div class="col-md-2" >
                                                        <?php 
                                                        if(isset($extra_prgrm_cmd1))
                                                        {
                                                          $extra_prgrm_cmd1 = $extra_prgrm_cmd1;
                                                        }
                                                        else
                                                        {
                                                          $extra_prgrm_cmd1 = '';
...
if (isset($rel_program_review_by_emp[0])) {
                                                       ...
                                                       <div class="col-md-1">
                                                        ...
                                                        <div class="col-md-1">
                                                            <div class="input-group input-medium date col-md-1" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years" >
                                                            <?php
                                                                    if (isset($IDP_data['0']['rel_target_date'])) { $rel2 = explode(';',$IDP_data['0']['rel_target_date']);  ?>
                                                                       <input class="form-control target_date3 col-md-1" readonly="" type="text" value="<?php if(isset($rel2[0])) { echo $rel2[0]; } ?>" style="width:107px" id="target_date3">
                                                                   <?php }
                                                                    else
                                                                    { ?>
                                                                       <input class="form-control target_date3 col-md-1" readonly="" type="text"  style="width:107px" id="target_date3">
                                                                 <?php   }
                                                                ?>
...
{
 echo CHtml::dropDownList("rel_prg_status_emp-3",'',$review_type,$htmlOptions=array('class'=>"form-control rel_prg_status_emp-3",'options' => $status));
}
                                                    ?>
                                                        ...
                                                        {
                                                          $rel_program_emp_cmd0 = $rel_program_emp_cmd0;
                                                        }
                                                        else{
...
{
 echo CHtml::dropDownList("rel_prg_status_mgr-0",'',$review_type,$htmlOptions=array('class'=>"form-control rel_prg_status_mgr-0",'options' => $status));
}
                                                    ?>
...
echo CHtml::textArea('rel_program_review0',$rel_prgrm_cmd1,$htmlOptions=array('class'=>"form-control col-md-2 rel_program_review",'id'=>'rel_program_review-0'));
                                                    ...
                                                    <div class="form-group">                                                        
                                                       ...
                                                       <div class="col-md-1">
                                                        ...
                                                        <div class="col-md-1">
                                                            <div class="input-group input-medium date" data-date="12-02-2012" data-date-format="dd-mm-yyyy" data-date-viewmode="years" style="width: 106px !important">
                                                            <?php
...
{
 echo CHtml::dropDownList("rel_prg_status_emp-4",'',$review_type,$htmlOptions=array('class'=>"form-control rel_prg_status_emp-4",'options' => $status));
}
                                                    ?>
                                                        ...
                                                        <div class="col-md-2">
                                                        <?php
                                                        if(isset($rel_program_emp_cmd1))
                                                        {
                                                          $rel_program_emp_cmd1 = $rel_program_emp_cmd1;
                                                        }
                                                        else
                                                        {
                                                          $rel_program_emp_cmd1 = '';
...
{
 echo CHtml::dropDownList("rel_prg_status_mgr-1",'',$review_type,$htmlOptions=array('class'=>"form-control rel_prg_status_mgr-1",'options' => $status));
}
                                                    ?>
                                                ...
                                                <div class="form-group last">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        if (isset($IDP_data['0']['project_q1_review_by_emp'])) {
                                                          $project_mid_review_by_emp = $IDP_data['0']['project_q1_review_by_emp'];
                                                        }
                                                        else
                                                        {
                                                          $project_mid_review_by_emp = '';
                                               ...
                                               <thead>
                                                ...
                                                <tbody>
                                                   ...
                                                   <td class="col-md-4" style="border:1px solid #c2cad8;border-bottom: 1px solid #c2cad8;">
                                                            <?php  if (isset($kpi_data['0']['q1_emp_cmt1'])) { ?>
                                                            <textarea class="form-control col-md-4 emp_cmt1" style="border:1px solid #c2cad8"><?php if(isset($kpi_data['0']['q1_emp_cmt1'])) { echo $kpi_data['0']['q1_emp_cmt1']; } }
                                                   ...
                                                   <?php 
                                                        ...
                                                        <td style="border:1px solid #c2cad8;border-bottom: 1px solid #c2cad8;"><textarea class="form-control col-md-4 mgr_cmt1" style="border:1px solid #c2cad8;text-align:left">
                                                         <?php 
                                                            echo $kpi_data['0']['q1_mgr_cmt1'];
                                                        }
                                                        else{
                                                            echo "";
                                                        }
                                                     ...
                                                     <td style="border:1px solid #c2cad8;border-bottom: 1px solid #c2cad8;">
                                                        ...
                                                        if (isset($kpi_data['0']['q1_emp_cmt2'])) { ?>
                                                            <textarea class="form-control col-md-4 emp_cmt2" style="border:1px solid #c2cad8;text-align:left"> <?php  if(isset($kpi_data['0']['q1_emp_cmt2'])) { echo $kpi_data['0']['q1_emp_cmt2']; }
                                                        }
                                                        else{
                                                            echo "";
                                                        }
                                                        ...
                                                        <td style="border:1px solid #c2cad8;border-bottom: 1px solid #c2cad8;">
                                                             <?php 
                                                        if (isset($kpi_data['0']['q1_mgr_cmt2'])) { ?>
                                                            <textarea class="form-control col-md-4 mgr_cmt2" style="border:1px solid #c2cad8;text-align:left">
                                                           <?php
                                                            echo $kpi_data['0']['q1_mgr_cmt2'];
                                                        }
                                                        else{
                                                            echo "";
                                                        }
                                                    ...
                                                    <td style="border:1px solid #c2cad8;border-bottom: 1px solid #c2cad8;">
                                                        ...
                                                        if (isset($kpi_data['0']['q1_emp_cmt3'])) { ?>
                                                            <textarea class="form-control col-md-4 emp_cmt3" style="border:1px solid #c2cad8;text-align:left"><?php  if(isset($kpi_data['0']['q1_emp_cmt3'])) { echo $kpi_data['0']['q1_emp_cmt3']; }
                                                        }
                                                        else{
                                                            echo "";
                                                        }
                                                        ...
                                                        if (isset($kpi_data['0']['q1_mgr_cmt3'])) { ?>
                                                            <textarea class="form-control col-md-4 mgr_cmt3" style="border:1px solid #c2cad8;text-align:left"><?php  if(isset($kpi_data['0']['q1_mgr_cmt3'])) { echo $kpi_data['0']['q1_mgr_cmt3'];}}else{ echo "";} ?></textarea></td>
                                                    </tr>
...
//{      
?>
                                        <label id="total_kra_id" style="display: none"><?php if(isset($kpi_id_data)) { echo $kpi_id_data; } ?></label>     
 
                    <input name="term_condition" type="checkbox" value="term_condition" id="term_condition"/><lable id="blink_me" style="color: red;"> I confirm this Quater1 review is discussed and agreed
with <?php if(isset($employee_data['0']['Emp_fname'])) { echo $employee_data['0']['Emp_fname']." ".$employee_data['0']['Emp_lname']; } ?></lable>
                                        <?php echo CHtml::button('Approve Quater1 review of '.$employee_name,array('class'=>'btn border-blue-soft send_for_appraisal','style'=>'float:right;margin-bottom: 10px;','id'=>$kpi_data['0']['Employee_id'],'onclick'=>'js:send_notification();')); ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <p> <i class="fa fa-check" style="color:green"></i> Quater1 review Completed </p>
                                    <p> <i class="fa fa-times" style="color:red"></i> Quater1 IDP not Completed </p>
                                </div>
...
<?php 
            $form=$this->beginWidget('CActiveForm', array(
                                                                    ...
                                                                    'action' => array('index.php/IDP2/q1_subordinate_idp'),
                                                                ));
                                                                 ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Quater1/"><button type="button" class="btn border-blue-soft">OK</button></a>                                   
                                </div>
                            </div>
                        </div>
                    </div>
                 ...
                 <div id="static" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                <h4 class="modal-title">IDP Quater1 Review</h4>
                            </div>
                        ...
                        var id = id_value.split('-');var mid_review = ''; var review_comments = '';
                          $("#updation_spinner-"+id[1]).show();                         
                           ...
                           for (var i = 0; i < $("#get_kpi_count-"+id[1]).text(); i++) {
                              ...
                              {
                                error = "Please Select Quater1 Review Status";
                              }
                              else
                              {
                                 if (mid_review == '') 
                            ...
                            success : function(data)
                            {
                               $("#updation_spinner-"+id[1]).hide();
                                if (data == 'success') 
                                {
                                    ...
                                    $("#err").text("Quater1 Review updated successfully.");
                                } 
...
//                               }
//                               else if ((comment_data == undefined || comment_data =='') && $(".kpi_status_type-"+id[j]+i).find(':selected').val()=='Needs Attention')  
//                               {
...
//                           chk_cmnts==0;
//                         }
//                         else if((chk.test($("#program_review-"+i).val()) || $("#program_review-"+i).val() === undefined || $("#program_review-"+i).val() == '') && ($("#tot_prog_status_mgr-"+i+" option:selected").text() == "Needs Attention"))
//                         {
//                             chk_cmnts++;
    ...
    for (var j = 0; j < $("#total_kra_number").text(); j++) {
       ...
       // alert(j);
        for (var i = 0; i < $("#get_kpi_count-"+id[j]).text(); i++) { 
            ...
            if($(".kpi_status_type-"+id[j]+i).find(':selected').val() == 'Select')
            {
                err4 = "Please Select Quater1 Review Status";
                 $(".kpi_status_type-"+id[j]+i).focus();
                $(".kpi_status_type-"+id[j]+i).css('border','1px solid red');
                $('#err').text("Please Select Quater1 Review Status");
                $('#err').show();
                break;
            }
            else if ((comment_data == undefined || comment_data =='' || comment_data == "NA") && $(".kpi_status_type-"+id[j]+i).find(':selected').val()=='Needs Attention')  
            {
                ...
                $(".review_comment"+id[j]+i).focus();
                $(".review_comment"+id[j]+i).css('border','1px solid red');
                $('#err').text("Please enter comments on quater1 review");
                $('#err').show();
                break;
            }
            else if(chk_colon.test(comment_data))
...
//alert(err3);alert(err4);alert(err5);
...
//save_detail_pdf();
                ...
                <div id="redirect_page" class="modal fade" tabindex="-1" data-backdrop="redirect_page" data-keyboard="false">
                    <div class="modal-dialog">
                        <div class="modal-content"> 
                         <div class="modal-body">
                                    <p> Quater1 review updation done successfully. </p>
                                </div>
                                <div class="modal-footer">
