...
<div class="col-md-12" style="margin-top: 58px;">
                                <a href="<?php echo Yii::app()->request->baseUrl; ?>/pmsuser/index.php/IDP/IDP_approvegoal_list"><?php echo CHtml::button('Back',array('class'=>'btn border-blue-soft','style'=>'float:right;margin-right: 13px;margin-top: -64px;
}')); ?></a></div>
                                                         ...
                                                         <?php
                                                                  if (isset($IDP_data['0']['project_review_date'])) { ?>
                                                                   ...
                                                                   <?php }
                                                                    ...
                                                                    { ?>
                                                                       <input class="form-control date_pickup" readonly="" type="text" id="review_date">
                                                                 <?php   }
                                                                ?>
                                                    </div>
                                                </div>
...
else
{
 echo CHtml::textField('reviewer_nm',$review_name,$htmlOptions=array('maxlength'=>80,'class'=>"form-control col-md-4 reviewvers_name"));
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">                                
                                    <?php if(isset($IDP_data) && count($IDP_data)>0 && $IDP_data['0']['set_status']!='Approved')
                                    { ?>
