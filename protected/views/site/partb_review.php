                    ...
                    if(error==''){
                                ...
                                var base_url = window.location.origin;
                                    ...
                                    $.ajax({
                                        ...
                                        datatype : 'html',
                                        data : data,
                                        url : base_url+'/pmsapp/pmsuser/index.php?r=Register/savedata',
                   ...
                   if(error ==''){
                                ...
                                var base_url = window.location.origin;
                                    ...
                                    $.ajax({
                                        ...
                                        datatype : 'html',
                                        data : data,
                                        url : base_url+'/pmsapp/pmsuser/index.php?r=Register/update_yer',
                                        success : function(data)
                                        {
                                            $("#err").addClass("alert-success"); 
...
?>
            ...
            <div class="col-md-12">
                ...
                <a href="<?php echo Yii::app()->request->baseUrl; ?>/pmsuser/index.php?r=Subordinate/yearendlist" class="nav-link "><?php echo CHtml::button('Back',array('class'=>'btn blue-soft ','style'=>'float:left;width: 81px;')); ?></a>
