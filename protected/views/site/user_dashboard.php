...
<script type="text/javascript">
        $(function(){
         $(".chk_team_setgol_status").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php?r=User_dashboard/teamSetgoalstatus',
         ...
         $(".chk_team_idp_status").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php?r=User_dashboard/teamIdpstatus',
            success : function(data)
            {
               // alert(data);
                var table = $('#sample_editable_1').DataTable();
          ...
          $(".chkteam_mid_stat").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php?r=User_dashboard/teamMidstatusget',
            success : function(data)
            {
                //alert(data);
                var table = $('#sample_editable_1').DataTable();
...
var data = {
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php/Setgoals/emp_kpi_edit',
            success : function(data)
            {
                var base_url = window.location.origin;
                window.location.assign(base_url+'/kritvapms/index.php/Setgoals/emp_kpi_edit');
            }
          });
         //$("#contact-form").submit();
        });
...
var data = {
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php/IDP/subordinate_idp',
            success : function(data)
            {
                var base_url = window.location.origin;
                window.location.assign(base_url+'/kritvapms/index.php/IDP/subordinate_idp');
            }
          });        
        });
...
var data = {
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php/Midreview/midreview_emp_data',
            success : function(data)
            {
                var base_url = window.location.origin;
                window.location.assign(base_url+'/kritvapms/index.php/Midreview/midreview_emp_data');
            }
          });   
...
var data = {
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php/IDP/Midyear_subordinate_idp',
            success : function(data)
            {
                var base_url = window.location.origin;
                window.location.assign(base_url+'/kritvapms/index.php/IDP/Midyear_subordinate_idp');
            }
          });  
        ...
        $(".chkteam_mididp_stat").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php?r=User_dashboard/teamMidIdpstatusget',
            success : function(data)
            {
                //alert(data);
                var table = $('#sample_editable_1').DataTable();
 ...
 $(".chk_team_yearEnd_status").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php/User_dashboard/TeamYearEndstatus',
            success : function(data)
            {
                //alert(data);
                var table = $('#sample_editable_1').DataTable();
          ...
          $(".chk_team_yearEndIDP_status").click(function(){
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php/User_dashboard/TeamYearEndsIDPtatus',
            success : function(data)
            {
             // alert(data);
                var table = $('#sample_editable_1').DataTable();
