...
<label id="start_date" style="display:none" >01/Apr/<?php echo $f_year_comp['0'];?></label>
<label id="end_date" style="display:none" >31/Mar/<?php echo $f_year_comp['1'];?></label>
...
<div id="static_prg" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                    ...
                    <div class="page-content-container">
                        <div class="page-content-row">
                           ...
                           <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Rules"><button type="button" data-dismiss="modal" class="btn border-blue-soft" style="float:right">Rules For Goalsheet & IDP</button></a>
                                        ...
                                        <table id="kpi_table" class="table table-striped table-bordered table-hover" style="background-color: #EEF1F5;">
                                                    <tr>
                                                           ...
                                                           $format_list = array('Select' => 'Select','Days' => 'Days','Date' => 'Date','Units' => 'Units','Weight' => 'Weight','Ratio' => 'Ratio','Value' => 'Value','Percentage' => 'Percentage','Text' => 'Text');
                                                            $wtage = array('15'=>'15','20'=>'20','25'=>'25','30'=>'30','40'=>'40');
...
//print_r($KRA_category_auto);die();
                                        ...
                                        echo CHtml::DropDownList('faculty_email_id','faculty_email_id',$Cadre_id,array('class'=>'form-control faculty_email_id','empty'=>'Select','style'=>'width: 186px;float: left;'));
                                             ...
                                             {?>
                                                   ...
                                                   <label id="kpi_list_number" style="display:none"><?php if($kpi_count != '' && count($kpi_count) != 1)
                                                    {
                                ...
                                <div class="col-md-12" style="margin-top: -18px;">
                                    ...
                                    <div class="portlet light form-fit" id="refresh_class">
                                        <div class="portlet-title">
                                            ...
                                            <lable id="compare_designation" ><?php if(isset($designation_flag)) { echo $designation_flag; } ?></lable>
                                        </div>
                                    ...
                                    if (isset($program_data_result) && count($program_data_result)>0) {
                                        for ($i=0; $i < count($program_data_result); $i++) {    
                                         ...
                                         $cmnt = '';
                                            ...
                                            if ($program_data_result[$i]['need'] == 2) {
                                                if ($compulsory == '') {
                                                   $compulsory = $i;
                                                }
                                                else
                                            ...
                                            else if ($program_data_result[$i]['need'] == 1) {
                                                if ($compulsory == '') {
                                                   $compulsory = $i;
                                                }
                                                else
                            ...
                            $.ajax({
                                ...
                                {                              
                                    if (data == "success")
                                    {
                                        ...
                                        window.location.href = base_url+'/kritvapms/index.php?r=Setgoals';
                                        //location.reload();
                                    }
                                                ...
                                                else
                                                {
                                                   var asc = 0;var desc = 0;
                                                    ...
                                                    //alert(asc);alert(desc);
                                                      if(desc!=4 && asc !=4)
                                                      { 
                                                         er = "Date should contain proper data";
                                                      }
                                                    if (kpi_value == '')
                                                    {
                                                        kpi_value = $(".target_value1"+i).val()+'-'+$(".target_value2"+i).val()+'-'+$(".target_value3"+i).val()+'-'+$(".target_value4"+i).val()+'-'+$(".target_value5"+i).val();
                        ...
                        if(error != '')
                        {
                         ...
                         { 
                            ...
                            $.ajax({
                                ...
                                datatype : 'html',
                                data : data,
                                url : base_url+'/kritvapms/index.php?r=Setgoals/savekpi',
                                success : function(data)
                                {
                                   // alert(data);
                                    if (data == "Success")
                       ...
                       // alert($('.target_value').find(':selected').val());
                        var base_url = window.location.origin;
                         $.ajax({
                                ...
                                datatype : 'json',
                                data : selected_unit,
                                url : base_url+'/kritvapms/index.php?r=Setgoals/gettarget_value2',
                                success : function(data)
                                { 
                                    //alert(data);
var detail = jQuery.parseJSON(data);
...
function save_detail_pdf()
                { 
                    ...
                    success : function(data)
                    {
                        ...
                        location.href = base_url+'/Goalsheet_docs/goalsheet'+'_'+$("#femp_name").text()+'_'+$("#lemp_name").text()+'.pdf'; 
                    }
                    });                 
                }
</script>
...
<label style="font-size:8px;">Employee Name :  <?php if(isset($employee_data['0']['Emp_fname'])) { echo $employee_data['0']['Emp_fname'].' '.$employee_data['0']['Emp_lname']; }?></label><br><label style="float: right;font-size:8px;">Manager's Name :  <?php if(isset($mgr_data) && count($mgr_data)>0){
                     echo $mgr_data[0]['Emp_fname']." ".$mgr_data[0]['Emp_lname'];}
                ?></label><br/>
<label style="font-size:8px;">Goalsheet Of Year:  <?php if($kpi_data['0']['goal_set_year']) { echo $kpi_data['0']['goal_set_year']; }?></label>
