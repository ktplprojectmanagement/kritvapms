 ...
 $(function(){
        $(".chk_user_status").click(function(){
           ...
           //alert(id);
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php?r=Admin_Dashboard/statusget',
 ...
 $(function(){
        $(".chk_user_status1").click(function(){
           ...
           var data = {
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php?r=Admin_Dashboard/statusgetMid',
            success : function(data)
            { 
                //alert(data);
                var table = $('#sample_1').DataTable();
   ...
   $(function(){
        $(".chk_user_idp_status").click(function(){
           ...
           var data = {
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php?r=Admin_Dashboard/statusgetIdp',
            success : function(data)
            { 
              //  alert(data);
                var table = $('#sample_1').DataTable();
    ...
    $(function(){
        $(".chk_user_Mididp_status").click(function(){
           ...
           var data = {
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php?r=Admin_Dashboard/getMidIdpStat',
            success : function(data)
            { 
                //alert(data);
                var table = $('#sample_1').DataTable();
 ...
 $(function(){
        $(".chk_user_year_end_status").click(function(){
           ...
           var data = {
            ...
            datatype : 'html',
            data : data,
            url : base_url+'/kritvapms/index.php/Admin_Dashboard/getYearEndStat',
            success : function(data)
            { 
               alert(data);
