...
padding-top: 10px;
                ...
                <div class="page-content">
                    <div class="container">
                        <div class="page-content-inner">
                            ...
                            <div>
                             <div id="err" style="display:none"></div>
                                ...
                                <td>
                                    <textarea id="field_1" disabled="true"  class="form-control" maxlength="400" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0 && isset($emp_promotion_data['0']['field1'])){ echo $emp_promotion_data['0']['field1']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea id="field_2"  disabled="true"  class="form-control " maxlength="400" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0  && isset($emp_promotion_data['0']['field2'])){ echo $emp_promotion_data['0']['field2']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea id="field_3" disabled="true"  class="form-control " maxlength="400" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0  && isset($emp_promotion_data['0']['field3'])){ echo $emp_promotion_data['0']['field3']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea id="field_4" disabled="true"  class="form-control " maxlength="400" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0  && isset($emp_promotion_data['0']['field4'])){ echo $emp_promotion_data['0']['field4']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea id="field_5" disabled="true"  class="form-control " maxlength="400" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0 && isset($emp_promotion_data['0']['field5'])){ echo $emp_promotion_data['0']['field5']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea id="field_6" disabled="true"  class="form-control " maxlength="400" name="employee_review1"  required><?php if(isset($emp_promotion_data['0']['field6'])){ echo $emp_promotion_data['0']['field6']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea id="field_7" disabled="true"  class="form-control " maxlength="400" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0 && isset($emp_promotion_data['0']['field7'])){ echo $emp_promotion_data['0']['field7']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea id="field_8" disabled="true"   class="form-control " maxlength="400" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0 && isset($emp_promotion_data['0']['field8'])){ echo $emp_promotion_data['0']['field8']; }?></textarea>
                                </td>  
                                <tr>
                                    <td colspan="2">
                        ...
                        <?php 
                        // echo CHtml::button('Submit',array('class'=>'btn btn-primary ','style'=>'float:right','id'=>'promotion_form_submit')); 
                        ?>
                                    </div>
                                    </td>
                                </tr>
