...
if($counts['People']>1 || $counts['People']==1){
     $cnt_kra_cat_people1=1;
}
if($counts['Customer']>1 || $counts['Customer']==1){
     $cnt_kra_cat_customer1=1;
}
if($counts['Process']>1 || $counts['Process']==1){
    $cnt_kra_cat_process1=1;
}
if($counts['Business']>1 || $counts['Business']==1){
...
else if($counts['Customer']>1){
    $cnt_cat=1;
}
else if($counts['Process']>1){
    $cnt_cat=1;
}
else if($counts['Business']>1){
    $cnt_cat=1;
}
else{
    $cnt_cat=0;
           ...
           j(".date_pickup").attr('value',$(this).val());
                    ...
                    $("body").on('click','.del_kpi',function(){
                        ...
                        $("body").on('click','#del_goal_set',function(){
                            ...
                            datatype : 'html',
                            data : data,
                            url : base_url+'/kritvapms/index.php?r=Setgoals2/kpi_del1',
                            success : function(data)
                            {
                                //alert(id_value[1]);
                ...
                'extra_kpi' : 1,
                        ...
                        var base_url = window.location.origin;
                         $.ajax({
                                ...
                                datatype : 'json',
                                data : selected_unit,
                                url : base_url+'/kritvapms/index.php?r=Setgoals2/gettarget_value1',
                                success : function(data)
                                { 
...
var ltr_str = get_id[1].substring(0,get_id[1].length - 1);
                    ...
                    $('body').on('keyup','.value_field',function(e){
                                       ...
                                       console.log(selected_unit1);
                                        ...
                                        if ($.isNumeric(data_value)) {
                                           $.ajax({
                                            ...
                                            datatype : 'html',
                                            data : selected_unit1,
                                            url : base_url+'/kritvapms/index.php?r=Setgoals2/fetch_field',
                                            success : function(data)
                                            {
                                ...
                                $('body').on('keypress','.kpi_list',function(event){
                                            ...
                                            datatype : 'html',
                                            data : kpi_value,
                                            url : base_url+'/kritvapms/index.php?r=Setgoals2/kpi_list',
                                            success : function(data)
                                            {
                                                if (data != '') 
                                                {
                    ...
                    <div class="page-content-container">
                        <div class="page-content-row">
                            ...
                            <div class="page-content-col">
                                    ...
                                    <div class="row">
                                     <?php 
                                       ...
                                       'id'=>'user-form',
                                        ...
                                        //'action' => $this->createUrl('Setgoals2/save_kpi'),                                        
                                    ));
                                    ?>
                                    <div class="col-md-5">
                                ...
                                <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Setgoals2/approvegoal_list"><?php echo CHtml::button('Back',array('class'=>'btn border-blue-soft','style'=>'float:right;margin-right: 13px;margin-top: -64px;
}')); ?></a>
<?php 
...
//print_r("iuyiuyiuy");die();
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Setgoals2/"><?php echo CHtml::button('Back',array('class'=>'btn border-blue-soft','style'=>'float:right;margin-right: 13px;')); ?></a>
                                            <?php }else{ ?>
...
<div>                                                
                                                   ...
                                                   <tr id="other_format_text">
                                                   <label id="kpi_list_number<?php echo $kpi_id; ?>" ><?php  if($kpi_count != '')
                                                    {
                                                        echo count($kpi_count);
                                                    }?></label>
...
<?php 
            $form=$this->beginWidget('CActiveForm', array(
                                                                    // 'id'=>'contact-form',
                                                                    'enableClientValidation'=>true,
                                                                    'action' => array('index.php/Setgoals2/emp_kpi_edit'),
                                                                ));
                                                                 ?>
<?php echo CHtml::textField('emp_id',$emp_data['0']['Employee_id'],array('style'=>'display:none')); ?>
                                                                  <?php echo CHtml::submitButton('OK',array('style'=>'float:right','class'=>'btn dark btn-outline')); ?>
                       ...
                       $("body").on('click','.del_kra_kpi',function(){
                            ...
                            $("#continue_del_krakpi").unbind('click').click(function(){
                                $("#show_spin_kpi").css('display','block');
                                    ...
                                    type : 'post',
                                    data : data,
                                    url : base_url+'/kritvapms/index.php?r=Setgoals2/krakpi_del',
                                    success : function(data)
                                    {
...
if($("#term_condition:checked").val() != 'term_condition')
                                            ...
                                            $.ajax({
                                                ...
                                                datatype : 'html',
                                                data : data,
                                                url : base_url+'/kritvapms/index.php?r=Setgoals2/update_emp_kpi_all',
                                                success : function(data)
                                                {
//alert(data);
                      ...
                      if($("#compare_designation").text() == 1 && $("#project_title1").val() == '' || $("#project_title1").val().length>500)
                        ...
                        else
                        {
                          ...
                          $.ajax({
                              ...
                              'datatype' : 'html',
                              'data' : data,
                              'url' : base_url+'/kritvapms/index.php?r=Setgoals2/final_goal_review1',
                            success : function(data)
                            { 
                                                    ...
                                                    $("#show_spin1").show();jQuery("#static").modal('hide');
                                                     var base_url = window.location.origin;
                                                        $.ajax({
                                                            ...
                                                            datatype : 'html',
                                                            data : data,
                                                            url : base_url+'/kritvapms/index.php?r=Setgoals2/goalapproved',
                                                            success : function(data)
                                                            {
                                                                //alert(data);
                        ...
                        if(error[kra_id_value1[j]] == '')
                          { 
                                            ...
                                            $.ajax({
                                                ...
                                                datatype : 'html',
                                                data : data,
                                                url : base_url+'/kritvapms/index.php?r=Setgoals2/update_emp_kpi',
                                                success : function(data)
                                                {
                                                    //alert(data);
                                                    var kra_val = $("#kpi_record-"+data).parent().parent().parent().attr('id');
                    ...
                    else if(!kpi_total_number < kpi_list_data)
                    {
                        ...
                        var base_url = window.location.origin;
                            ...
                            $.ajax({
                                ...
                                datatype : 'html',
                                data : data,
                                url : base_url+'/kritvapms/index.php?r=Setgoals2/save_kpi',
                                success : function(data)
                                {alert(data);
                                    // if (data != '') 
                                    // {
                        ...
                        $("#err").text(error);
                         ...
                         { 
                            ...
                            $.ajax({
                                ...
                                datatype : 'html',
                                data : data,
                                url : base_url+'/kritvapms/index.php?r=Setgoals2/savekpi1',
                                success : function(data)
                                {
                                    alert(data);
                                    if (data == "Success")
                ...
                function get_target_value()
                {
                    ...
                    var base_url = window.location.origin;
                     $.ajax({
                            ...
                            datatype : 'json',
                            data : selected_unit,
                            url : base_url+'/kritvapms/index.php?r=Setgoals2/gettarget_value',
                            success : function(data)
                            { 
                                //alert(detail[2]);
                                var detail = jQuery.parseJSON(data);
