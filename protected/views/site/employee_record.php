                            ...
                            <div class="page-content-col">
                               ...
                               <style type="text/css">
                                ...
                                <div class="col-md-6" style="float: left;margin-top: -52px;">
                                    <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Newemployee" class="nav-link nav-toggle"><input type='button' id="import_csv" class="btn sbold blue" value='New Employee' ></a>
                                </div>
