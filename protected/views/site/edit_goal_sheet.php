...
//   $('#faculty_email_id').prop('disabled', false);
$('.send_for_appraisal').prop('disabled',false);
$('.getapprove').prop('disabled',false);
$('#term_condition').prop('disabled',false);
});
...
// $Employee_id=$kpi_auto_data['0']['Employee_id'];
...
//     $cnt=1;
// }
// else if($counts['Customer']>2){
//     $cnt=1;
// }
// else if($counts['Process']>2){
//     $cnt=1;
// }
// else if($counts['Business']>2){
//     $cnt=1;
// }
// else{
//     $cnt=0;
...
var specialElementHandlers = {
                    ...
                    datatype : 'html',
                    data : data,
                    url : base_url+'/kritvapms/index.php?r=Checkattach/check_view1',
                  ...
                  var data1 = {
                    ...
                    datatype : 'html',
                    data : data1,
                    url : base_url+'/kritvapms/index.php?r=Checkattach/check_idp',
                    success : function(data)
                    {
                        //alert("dsfdsf");
                    }
           ...
           j(".date_pickup").attr('value',$(this).val());
                    ...
                    $("body").on('click','.del_kpi',function(){
                        ...
                        $("body").on('click','#del_goal_set',function(){
                            ...
                            datatype : 'html',
                            data : data,
                            url : base_url+'/kritvapms/index.php?r=Setgoals/kpi_del1',
                            success : function(data)
                            {
                                //alert(id_value[1]);
                ...
                'extra_kpi' : 1,
                        ...
                        var base_url = window.location.origin;
                         $.ajax({
                                ...
                                datatype : 'json',
                                data : selected_unit,
                                url : base_url+'/kritvapms/index.php?r=Setgoals/gettarget_value1',
                                success : function(data)
                                { 
...
$KRA_status_flag = $kpi_auto_data[$a]['0']['KRA_status'];
                                                           ...
                                                           $cities = array('Business'=>'Business','Process'=>'Process','People'=>'People','Customer'=>'Customer');
                                                             echo CHtml::dropDownList("target_value",'',$list,$htmlOptions=array('class'=>"form-control target_value kra_category-".$kpi_id,'onchange'=>'js:get_target_value();','options' => $kpi_category,'disabled' =>'disabled'));
                                                    ...
                                                    <tr>
                                                            <td style="">
                                                             ...
                                                             <td colspan=7 align="center" id="Weightage_list">
                                                           <?php  
                                                           echo CHtml::dropDownList("target_value",'',$wtage,$htmlOptions=array('class'=>"form-control Weightage",'id'=>'Weightage'.$kpi_id,'style'=>"width: 150px;float: left;",'options' => $wtg,'disabled' =>'disabled'));
                                                             ?>
                                                        </td>
                                                    </tr>
<tr>
...
else if(isset($emp_all_detail['0']['reporting_1_change']) && $emp_all_detail['0']['reporting_1_change'] =='' && $emp_all_detail['0']['Reporting_officer2_id'] != '')
{
     $head_array['1'] = $emp_all_detail['0']['Reporting_officer2_id'];
}
if(isset($emp_all_detail['0']['Reporting_officer2_id']) && $emp_all_detail['0']['Reporting_officer2_id'] == '')
...
<div>                                                
                                                   ...
                                                   <tr id="other_format_text">
                                                   <label id="kpi_list_number<?php echo $kpi_id; ?>" style="display:none" ><?php  if(isset($kpi_count) && $kpi_count != '')
                                                    {
                                                        echo count($kpi_count);
                                                    }?></label>
...
<tr id="extra_kpi<?php echo $kpi_id; ?>">
                    ...
                    <style type="text/css">
                                              ...
                                              else
                                              {
                                                ...
                                                echo CHtml::button('Add KPI',array('class'=>'btn border-blue-soft add_kpi','style'=>'float:left;margin-left: 10px;display:none','id'=>'add_kpi-'.$kpi_id.'-'.$list_cnt));
 ?>
                                            </div>       
...
echo CHtml::button('Delete',array('class'=>'btn border-blue-soft del_kpi','id'=>'KPI_id-'.$kpi_id,'style'=>'float:right;margin-right: 14px;display:none'));
?>
...
<?php
        ...
        $_POST['emp_id'] = Yii::app()->user->getState('emp_id1');
...
echo CHtml::textField('program_cmd',$cmnt,$htmlOptions=array('class'=>"form-control col-md-4 program_cmd",'id'=>'program_cmd-'.$i));
                                    ...
                                    <tr  <?php if(isset($IDP_data['0']['set_status']) && $IDP_data['0']['set_status']!='Approved')
                                                  { ?>style="display:none"<?php }else { ?>style="display:none"<?php } ?>>                                       
		...
		$list = array('goal_set_year');
		$data = array(Yii::app()->user->getState('financial_year_check'));
		$list_of_program = $program_data->get_kpi_data($where,$data,$list);
                                                  ...
                                                  for ($ln=0; $ln < count($list_of_program); $ln++) { 
                                                    for ($li=0; $li < count($list_prog); $li++) {
                                                      $list_prog2 = explode('?',$list_prog[$li]);
                                                        if (isset($list_prog2[0]) && $ln == $list_prog2[0]) 
                                                        {
                                                          $list_prog1[$ln] = '1'; 
                                                          break;                                                       
                                                        }
                                            ...
                                            echo CHtml::DropDownList('program_name_list','program_name_list',$Cadre_id,array('class'=>'form-control program_name_list','empty'=>'Select','style'=>'display:none')); ?>
                                    </td>
                                     <td colspan="4">
                                               <?php
                                                  if(isset($IDP_data) && count($IDP_data)>0 && $IDP_data['0']['set_status']!='Approved')
                                                  { ?>
                                                      <button type="button" class="btn btn-primary comp_add_program" id="<?php if(isset($cmt2) && count($cmt2)>0) { echo $compulsory_cnt; } ?>" style="float: left;display:none">Add Program</button>
                                                <?php  }
                                                ?>
                                        </td>
                                    </tr>                               
...
if(isset($IDP_data['0']['set_status']) && count($IDP_data)>0 && $IDP_data['0']['set_status']=='Approved') {
echo CHtml::DropDownList('faculty_email_id'.$m,'faculty_email_id1',$Cadre_id,array('disabled' => 'disabled','class'=>'form-control faculty_email_id'.$m,'empty'=>'Select','options' => $faculty,'disabled'=>'disabled')); 
}
else
{
 echo CHtml::DropDownList('faculty_email_id'.$m,'faculty_email_id1',$Cadre_id,array('class'=>'form-control faculty_email_id'.$m,'empty'=>'Select','options' => $faculty,'disabled'=>'disabled'));
}
                                                            ?>
                                                        </div>
                                                ...
                                                <?php
                                                  if(isset($IDP_data) && count($IDP_data)>0 && $IDP_data['0']['set_status']!='Approved')
                                                  { ?>
                                                      <button type="button" class="btn btn-primary add_program" id="<?php echo $count_value.'-'.$IDP_data['0']['Employee_id']; ?>" style="float: left;display:none">Add Program</button>
                                                <?php  }
                                                ?>    
...
<span class="caption-subject  bold uppercase" style="color:white;font-size: 12px;">Part B: Development through developmental relationships</span><br>
                                                   ...
                                                   <div class="form-group">                                                        
                                                        ...
                                                        <label class="control-label col-md-2 bold" style="text-align: left;">Number of Meetings planned
                                                         ...
                                                         <label class="control-label col-md-2 bold" style="text-align: left;">Topic To be disscussed
                                                        </label>
                                                        <label class="control-label col-md-2 bold" style="text-align: left;">Target date</label>
                       ...
                       $("body").on('click','.del_kra_kpi',function(){
                            ...
                            $("#continue_del_krakpi").unbind('click').click(function(){
                                $("#show_spin_kpi").css('display','block');
                                    ...
                                    type : 'post',
                                    data : data,
                                    url : base_url+'/kritvapms/index.php?r=Setgoals/krakpi_del',
                                    success : function(data)
                                    {
...
if($("#term_condition:checked").val() != 'term_condition')
                                            ...
                                            $.ajax({
                                                ...
                                                datatype : 'html',
                                                data : data,
                                                url : base_url+'/kritvapms/index.php?r=Setgoals/update_emp_kpi_all',
                                                success : function(data)
                                                {
//alert(data);
...
$("#show_spin2").css('display','none');
            ...
            $("#err").hide();
                ...
                if($(".kra_category-"+error_count1).find(':selected').val() == '--Select--')
                          ...
                          {
var chk_cmnts = 0;var chk_cmnts1 = 0;var chk_cmnts2 = 0;var chk_compl = 0;var chk_compl1 = 0;var chk_txt_idp = 0;
                            ...
                            for (var j = 0; j < get_list_value.length; j++) {                                
                                    if (get_list_value[j] == i && ($("#program_cmd-"+get_list_value[j]).val() === undefined || $("#program_cmd-"+get_list_value[j]).val() == '' || chk.test($("#program_cmd-"+get_list_value[j]).val())))
                                    {
                                        ...
                                        $("#program_cmd-"+get_list_value[j]).css('border-color','red');
                                         $("#program_cmd-"+get_list_value[j]).focus();
                                        $('#err').show();
                                         $("#err").text("Compulsary Program should not be blank."); 
                                         j=get_list_value.length;
                                        break;
...
//alert(chk_cmnts1);
                    ...
                    //alert($("#compare_designation").text());
if (chk_compl1 == 1) 
                    {
                         $('body').animate({
                      ...
                      if($("#compare_designation").text() == 1 && $("#project_title1").val() == '' || $("#project_title1").val().length>500)
                        ...
                        else
                        {
                          ...
                          $.ajax({
                              ...
                              'datatype' : 'html',
                              'data' : data,
                              'url' : base_url+'/kritvapms/index.php?r=Setgoals/final_goal_review1',
                            success : function(data)
                            { 
                               // alert(data);
                                if (data == 1 || data == "No changes done" || data == "")  
                                {
                                     $("#show_spin2").css('display','block');
                                var data = {
                                    emp_id : $(".send_for_appraisal").attr('id')
                        ...
                        if(error[kra_id_value1[j]] == '')
                          { 
                                            ...
                                            $.ajax({
                                                ...
                                                datatype : 'html',
                                                data : data,
                                                url : base_url+'/kritvapms/index.php?r=Setgoals/update_emp_kpi',
                                                success : function(data)
                                                {
                                                    //alert(data);
                                                    var kra_val = $("#kpi_record-"+data).parent().parent().parent().attr('id');
 ...
 function kpi_save_data_new()
                    ...
                    else if(!kpi_total_number < kpi_list_data)
                    {
                        ...
                        var base_url = window.location.origin;
                            ...
                            $.ajax({
                                ...
                                datatype : 'html',
                                data : data,
                                url : base_url+'/kritvapms/index.php?r=Setgoals/save_kpi',
                                success : function(data)
                                {//alert(data);
                                    // if (data != '') 
                                    // {
      ...
      function kpi_save_data()
            ...
            var wtg_value = $("#Weightage1").find(':selected').val();
                    ...
                    {
                        error="Selection of all KRA category is mandatory";
                    }
                   ...
                   error="Please select another KRA category";
                    }
                        ...
                        $("#err").text(error);
                         ...
                         { 
                            ...
                            $.ajax({
                                ...
                                datatype : 'html',
                                data : data,
                                url : base_url+'/kritvapms/index.php?r=Setgoals/savekpi1',
                                success : function(data)
                                {
                                    //alert(data);
                                    if (data == "Success")
                ...
                function get_target_value()
                {
                    ...
                    var ppl_cnt=0;var buis_cnt=0; var cust_cnt=0; var proc_cnt=0;
                    ppl_cnt=<?php echo $ppl ?>;
                    buis_cnt=<?php echo $buis ?>;
                    cust_cnt=<?php echo $cust ?>;
                    proc_cnt=<?php echo $proc ?>;
                    // alert(ppl_cnt);
                    // alert(buis_cnt);
                    // alert(cust_cnt);
                    // alert(proc_cnt);
