...
if(string_data[i] == 'norm_set_tab_active-date')
                        {
                             content_array[i] = 'norm_active-date';
                            if ($('#norm_active-date').val() !='') 
                            {
                                content_value[i] = $('#norm_active-date').val();
                                error = '';
                            }
                            else if($('#norm_active-date').val() =='')
                            {
                                error = 'Please enter cut off date for normalization.';
                            } 
                        }
if(string_data[i] == 'promo_set_tab_active-date')
                        {
                             content_array[i] = 'promo_active-date';
                            if ($('#promo_active-date').val() !='') 
                            {
                                content_value[i] = $('#promo_active-date').val();
                                error = '';
                            }
                            else if($('#promo_active-date').val() =='')
                            {
                                error = 'Please enter cut off date for promotion.';
                            } 
                        }
if(string_data[i] == 'dis_set_tab_active-date')
                        {
                             content_array[i] = 'dis_active-date';
                            if ($('#dis_active-date').val() !='') 
                            {
                                content_value[i] = $('#dis_active-date').val();
                                error = '';
                            }
                            else if($('#dis_active-date').val() =='')
                            {
...
<label id="PMS_display_format2"><?php echo date('Y'); ?></label>
 ...
 <li>
								...
								<ul class="new" style="display: none;width: 262px;">
                                                                    <li>
                                                                       <input name="sublevel-2-1" class="form-control date_select" type="text" id="norm_active-date"/>
                                                                    </li>
                                                                </ul>
                                                            </li>
 <li>
                                                                <label class="text_style1">
                                                                <input name="promo_active-date" type="checkbox" value="promo_set_tab_active-date"/>
                                                                 Cut Off date for promotion </label>
								<ul class="new" style="display: none;width: 262px;">
                                                                    <li>
                                                                       <input name="sublevel-2-1" class="form-control date_select" type="text" id="promo_active-date"/>
                                                                    </li>
                                                                </ul>
                                                            </li>
 <li>
                                                                <label class="text_style1">
                                                                <input name="dis_active-date" type="checkbox" value="dis_set_tab_active-date"/>
                                                                 Dissable Year End Review </label>
								<ul class="new" style="display: none;width: 262px;">
                                                                    <li>
                                                                       <input name="sublevel-2-1" class="form-control date_select" type="text" id="dis_active-date"/>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                        </ul>
