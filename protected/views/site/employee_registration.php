                            ...
                            <div class="page-content-col">
                                ...
                                <script type="text/javascript">                                    
                                    $(function(){
                                        ...
                                        //alert($('.reporting_1_change').find(':selected').val());
                                           var mname = '',lname = '',blood_grp = '';var gender='';var nationality = '';var state='';var city = '';var other_city = '';
                                            ...
                                            var appr=$(".cluster_appraiser").find(':selected').val();
                                            var cadre=$(".cadre").find(':selected').text();
                                            var pms=$(".pms_stat").find(':selected').val();
                                            var emp_stat=$(".emp_status").find(':selected').val();
                                            var dept=$(".department").find(':selected').text();
                                            var desg=$(".designation").find(':selected').text();
                                            var bu=$(".bu").find(':selected').text();
                                            var loc=$(".location").find(':selected').text();
                                            if(cadre=="Select") {
                                               cadre="";
                                            } 
                                           ...
                                           //alert(loc);
                                            ...
                                            form_data.append("pms_status",pms);
                                            form_data.append("reporting_1_change",$('.reporting_1_change').find(':selected').val());
                                            ...
                                            form_data.append("reporting_2_effective_date",$('#effective_date').val());
                                                   ...
                                                   $("#error_value").text('');
                                                     $("#err").hide(); 
                                                        ...
                                                        if(data == 'success')
                                                        {
                                                            ...
                                                            // if ($('.pms_stat').find(':selected').text()=="Select") {
                                                            ...
                                                            // else if ($('.pms_stat').find(':selected').text()!="Select"){
                                                            //alert("successfullllllly");
                                                            $("#updation_spinner").css('display','none');
                                                            $("#err").show();
                                                            $("#err").fadeOut(10000);
                                                            ...
                                                            if(data == 'Please Select .')
                                                                {
                                                                     ...
                                                                     $("#err").show();
                                                                     $("#error_value").text("Please Select ");
                                                                } 
                                                                ...
                                                                {
                                                                    $("#err").show();
                                                                    $("#error_value").text("File jpg/Jpeg/png files with 500kb max size are allowed.");
                                                                }
                                                                else  
                                                                {
                                                                    ...
                                                                    else if (obj.pms_status != undefined) 
                                                                    {
                                                                         $("#err").show();
                                                                         $("#pms_status").text('Please Select pms status');
                                                                    }
                                                                    else if(obj.Image != '')
                                                                    {
                                                                         $("#err").show();
...
<div class="form-group">
                                       <label class="control-label col-md-3">Select Cluster Appraiser<span class="required"> * </span></label>
                                        ...
                                        echo CHtml::activeDropDownList($model,'cluster_appraiser',$Report_id,array('class'=>'form-control cluster_appraiser','empty'=>'Select')); ?>
                                        </div>
                                    </div>    
...
<div class="form-group">
                                       <label class="control-label col-md-3">Change Main Manager <span class="required"> * </span></label>
                                         <div class="col-md-4" id="reporting_head">
                                         <?php 
                                         $reporting_list = new EmployeeForm();
                                         $records = $reporting_list->get_appraiser_list();
                                        ...
                                        echo CHtml::activeDropDownList($model,'Reporting_officer1_id',$Report_id,array('class'=>'form-control reporting_1_change','empty'=>'Select')); ?>
                                        </div>

                                    </div>
                                    <div class="form-group">        
                                        <label class="control-label col-md-3">Effective date for main manager change
                                            <span class="required"> * </span>
                                        </label>
                                         <div class="col-md-4">
                                       <?php 
                                     ...
                                     <div class="form-group">
                                       ...
                                       //print_r($Reporting_officer_data);die();
                                        ...
                                        echo CHtml::activeDropDownList($model,'Reporting_officer1_id',$Report_id,array('class'=>'form-control reporting_2_change','empty'=>'Select')); ?>
                                        </div>
