    ...
    padding-top: 10px;
                                        ...
                                        <table id="kpi_table" class="table" style="width: 100%;background-color: #EEF1F5;">
                                                    ...
                                                    <tr>
                                                            <td style="width:310px;" rowspan=2>
                                                             ...
                                                             <td style="text-align:center;" colspan=6>Target</td>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <td style="width:135px;"></td>
                                                        ...
                                                        <td align="center">(5) Outstanding <br>Performance</td>
                                                    </tr> 
     ...
     ?>"><?php echo CHtml::button('Edit',array('class'=>'btn border-blue-soft','style'=>'float:right')); ?></a><?php echo CHtml::button('Delete',array('class'=>'btn border-blue-soft del_kpi','id'=>'KPI_id-'.$row["KPI_id"],'style'=>'float:right;margin-right: 14px;')); ?>
                                        ...
                                        <?php echo CHtml::button('Final Submission',array('class'=>'btn border-blue-soft','style'=>'float:right','id'=>'send_for_appraisal','onclick'=>'js:send_notification();')); ?>
                                        <?php } ?>
                                    </div>                        
                                </div>
