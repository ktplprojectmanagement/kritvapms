...
<div style="float:right;margin-right: -9px;color: #9d9ba7;padding-top: 182px;" class="element" id="bottom"><i class="fa fa-arrow-circle-o-down fa-3" style="font-size:40px;cursor:pointer;margin-right: 0px;"></i><div style="margin-top: 8px;margin-left: -11px;text-align: center;">Click To <br> Go Down</div></div>
            ...
            <div class="container-fluid"> 
                 <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=Directreport/year_end_reviewlist"><?php echo CHtml::button('Back',array('class'=>'btn border-blue-soft','style'=>'float:right;margin-right: 13px;')); ?></a><br><br>                  
                                                            ...
                                                            else
                                                            {
                                                                ?>
                                                                 ...
                                                                 <tr>
                                                                   ...
                                                                   <tr>
                                                                    <td><?php echo round($kpi_value[$i]*0.69,3); ?></td>
                                                                    <td><?php echo round($kpi_value[$i]*0.70,3); ?></td>
                                                                       
                                                                     <td><?php echo round($kpi_value[$i]*0.96,3); ?></td>
                                                                        
                                                                    <td><?php echo round($kpi_value[$i]*1.06,3); ?></td>
                                                                        
                                                                     <td><?php echo round($kpi_value[$i]*1.39,3); ?></td>
                                                                   </tr>
                                                                 </table>
                                                                <?php
                                                            }
...
if (isset($appraiser_end_rating1[$i]) && count($appraiser_end_rating1)>0) {
                                                                 echo CHtml::textField('appraiser_raiting',$appraiser_end_rating1[$i],array('class'=>'form-control score','disabled'=> "true",'id'=>'appraiser_raiting-'.$i.'-'.$kpi_data[$k]['KPI_id'],'disabled'=> "true"));
                                                            }
                                                            else
                                                            {
                                                                 echo CHtml::textField('appraiser_raiting','',array('class'=>'form-control score','disabled'=> "true",'id'=>'appraiser_raiting-'.$i.'-'.$kpi_data[$k]['KPI_id'],'disabled'=> "true"));
                                                            }
}
else
{ 
if (isset($appraiser_end_rating1[$i]) && count($appraiser_end_rating1)>0 && isset($emp_data['0']['Reporting_officer1_id']) && $emp_data['0']['Reporting_officer2_id'] == $kpi_data[$k]['appraisal_id1'] && $emp_data['0']['Reporting_officer2_id'] != Yii::app()->user->getState("employee_email")) {
                                                                 ...
                                                                 echo CHtml::textField('appraiser_raiting',$appraiser_end_rating1[$i],array('class'=>'form-control score','disabled'=> "true",'id'=>'appraiser_raiting-'.$i.'-'.$kpi_data[$k]['KPI_id']));
                                                            }
                                                            else
                                                            {
                                                                 echo CHtml::textField('appraiser_raiting','',array('class'=>'form-control score','disabled'=> "true",'id'=>'appraiser_raiting-'.$i.'-'.$kpi_data[$k]['KPI_id']));
                                                            }
}
...
{
//echo  $seq_number[$f];
if(($seq_number[$f] == $kpi_data[$k]['KPI_id'].$i))
{
?>
                                   <a href='<?php echo Yii::app()->request->baseUrl; ?>/data(proof)/<?php  echo $doc_prf_by_emp[$f]; ?>' target="_blank"><?php echo CHtml::button('Open File',array('class'=>'btn yellow','style'=>'background-color:#26466D')); ?></a>
<?php } } ?>                                                 
</td>  
...
<?php } ?>
    ...
    <tr>
                        ...
                        <?php
                             ...
                             {
                                echo CHtml::textArea('employee_review1',$employee_review1,array('disabled'=>'true','class'=>'form-control','id'=>'target1','disabled'=>'true'));
                             }
                             else
                             {
                                echo CHtml::textArea('employee_review1',$employee_review1,array('disabled'=>'true','class'=>'form-control','id'=>'target1','disabled'=>'true'));
                    ...
                    <td class="col-md-10">
                        ...
                        if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{
                        echo CHtml::textArea('appr_comments_yearB1',$appr_comments_yearB1,array('disabled'=>'true','class'=>'form-control','id'=>'appr_comments_yearB1','disabled'=>'true'));
}
else
{
echo CHtml::textArea('appr_comments_yearB1',$appr_comments_yearB1,array('disabled'=>'true','class'=>'form-control','id'=>'appr_comments_yearB1'));
}
                        ?>
                    </td>
                    </tr>
                    ...
                    <td class="col-md-10">
                      ...
                      if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{ 
                        echo CHtml::textField('yearB_rate1', $yearB_rate1, array('disabled'=>'true','class'=>'form-control score1','id'=>'yearB_rate1','style'=>'width:100px','placeholder'=>"(Out of 25)",'maxlength'=>2,'disabled'=>'true'));
}
else
{
echo CHtml::textField('yearB_rate1', $yearB_rate1, array('disabled'=>'true','class'=>'form-control score1','id'=>'yearB_rate1','style'=>'width:100px','placeholder'=>"(Out of 25)",'maxlength'=>2));
}
                        ?>
                    </td>
                    </tr>
...
<?php } ?>
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{  
                            echo CHtml::textArea('appr_comments_yearB2',$appr_comments_yearB2,array('disabled'=>'true','class'=>'form-control','id'=>'appr_comments_yearB2','disabled'=>'true'));
}
else
{
echo CHtml::textArea('appr_comments_yearB2',$appr_comments_yearB2,array('disabled'=>'true','class'=>'form-control','id'=>'appr_comments_yearB2'));
}
                            ?>
                        </td>
                    </tr>
                    ...
                    <td>
                        ...
                        if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{   
                        echo CHtml::textField('yearB_rate2', $yearB_rate2, array('disabled'=>'true','class'=>'form-control score1','id'=>'yearB_rate2','style'=>'width:100px','placeholder'=>"(Out of 25)",'maxlength'=>2,'disabled'=>'true'));
}
else
{
 echo CHtml::textField('yearB_rate2', $yearB_rate2, array('disabled'=>'true','class'=>'form-control score1','id'=>'yearB_rate2','style'=>'width:100px','placeholder'=>"(Out of 25)",'maxlength'=>2));
}
                        ?> 
                    </td>
                    </tr>
...
<?php } ?>
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{   
                            echo CHtml::textArea('appr_comments_yearB3',$appr_comments_yearB3,array('disabled'=>'true','class'=>'form-control','id'=>'appr_comments_yearB3','disabled'=>'true'));
}
else
{
echo CHtml::textArea('appr_comments_yearB3',$appr_comments_yearB3,array('disabled'=>'true','class'=>'form-control','id'=>'appr_comments_yearB3'));
}
                            ?>
                        </td>
                    </tr>
...
{
echo CHtml::textField('yearB_rate3', $yearB_rate3, array('disabled'=>'true','class'=>'form-control score1','id'=>'yearB_rate3','style'=>'width:100px','placeholder'=>"(Out of 25)",'maxlength'=>2));
}
                        ?>
                    </td>
                    </tr>
...
{
echo CHtml::textArea('appr_comments_yearB4',$appr_comments_yearB4,array('disabled'=>'true','class'=>'form-control ','id'=>'appr_comments_yearB4'));
}
                            ?>
                        </td>
                    </tr>
...
{
echo CHtml::textField('yearB_rate4', $yearB_rate4, array('disabled'=>'true','class'=>'form-control score1','id'=>'yearB_rate4','style'=>'width:100px','placeholder'=>'(Out of 25)','maxlength'=>2));
}
...
<lable style="font-size: 22px;padding-left:10px;padding-top:5px;color:#fff;font-weight: bold;" id="kra_total_value1"><?php if(isset($IDP_data['0']['Tota_score'])) { echo $IDP_data['0']['Tota_score']; } ?></lable></lable><span class="bold" id="sum1" style="color:#fff">  </div>      
                                </div></div></div>                    </div>
...
if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{    
                                                    echo CHtml::textField('program_final_review',$program_individual_final_review,$htmlOptions=array('maxlength'=>80,'class'=>"form-control program_final_review validate_field",'disabled'=> "true",'id'=>'program_final_review-'.$i,'data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom",'disabled'=> "true"));
}
else
{
echo CHtml::textField('program_final_review',$program_individual_final_review,$htmlOptions=array('maxlength'=>80,'class'=>"form-control program_final_review validate_field",'disabled'=> "true",'id'=>'program_final_review-'.$i,'data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom"));
}
                                                ?> </td>
                                            </tr>
                                            <?php 
...
if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{ 
echo CHtml::textField('extra_program_final_review',$extra_program_final_review1,$htmlOptions=array('disabled' => 'true','class'=>"form-control validate_field extra_program_final_review",'id'=>'extra_program_final_review-'.$m,$set_flag,'data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom",'disabled' => 'true'));
}
else
{
echo CHtml::textField('extra_program_final_review',$extra_program_final_review1,$htmlOptions=array('disabled' => 'true','class'=>"form-control validate_field extra_program_final_review",'id'=>'extra_program_final_review-'.$m,'data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom"));
}
...
if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{ 
echo CHtml::textArea('rel_program_final_review0',$rel_program_final_review0,$htmlOptions=array('disabled' => true,'class'=>"form-control validate_field col-md-2 rel_program_final_review",'id'=>'rel_program_final_review-0','data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom",'disabled'=> "true"));
}
else
{
echo CHtml::textArea('rel_program_final_review0',$rel_program_final_review0,$htmlOptions=array('disabled' => true,'class'=>"form-control validate_field col-md-2 rel_program_final_review",'id'=>'rel_program_final_review-0','data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom"));
}
...
if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{ 
echo CHtml::textArea('rel_program_final_review1',$rel_program_final_review1,$htmlOptions=array('disabled' => true,'class'=>"form-control validate_field col-md-2 rel_program_final_review",'id'=>'rel_program_final_review-1','data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom",'disabled'=> "true"));
}
else
{
echo CHtml::textArea('rel_program_final_review1',$rel_program_final_review1,$htmlOptions=array('disabled' => true,'class'=>"form-control validate_field col-md-2 rel_program_final_review",'id'=>'rel_program_final_review-1','data-toggle'=>"popover","data-trigger"=>"hover","data-placement"=>"bottom"));
}
...
else
{
 echo CHtml::textArea('project_mid_review',$project_mid_review,$htmlOptions=array('class'=>"form-control  project_mid_review",));
      ...
      <div class="form-group last" style="border-bottom:1px solid #efefef">
                                                    <label class="col-md-3 control-label bold " >Project Final Review by Employee</label>
                                                    <div class="col-md-9">
                                                        <?php 
...
<table class="table table-bordered table-condensed">
                                ...
                                <td>
                                    <textarea   class="form-control field_1" disabled = 'true' maxlength="1000" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0 && isset($emp_promotion_data['0']['field1'])){ echo $emp_promotion_data['0']['field1']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea   class="form-control field_2" disabled = 'true' maxlength="1000" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0  && isset($emp_promotion_data['0']['field2'])){ echo $emp_promotion_data['0']['field2']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea  class="form-control field_3" disabled = 'true' maxlength="1000" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0  && isset($emp_promotion_data['0']['field3'])){ echo $emp_promotion_data['0']['field3']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea   class="form-control field_4" disabled = 'true' maxlength="1000" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0  && isset($emp_promotion_data['0']['field4'])){ echo $emp_promotion_data['0']['field4']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea   class="form-control field_5" disabled = 'true' maxlength="1000" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0 && isset($emp_promotion_data['0']['field5'])){ echo $emp_promotion_data['0']['field5']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea   class="form-control field_6 " disabled = 'true' maxlength="1000" name="employee_review1"  required><?php if(isset($emp_promotion_data['0']['field6'])){ echo $emp_promotion_data['0']['field6']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea  class="form-control field_7" disabled = 'true' maxlength="1000" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0 && isset($emp_promotion_data['0']['field7'])){ echo $emp_promotion_data['0']['field7']; }?></textarea>
                                </td>  
                                ...
                                <td>
                                    <textarea  class="form-control field_8" disabled = 'true' maxlength="1000" name="employee_review1"  required><?php if(isset($emp_promotion_data) && count($emp_promotion_data)>0 && isset($emp_promotion_data['0']['field8'])){ echo $emp_promotion_data['0']['field8']; }?></textarea>
                                </td> 
                                </tr>
                               <!-- <tr>
                            ...
                            <td>
                                ...
                                if (isset($normalize_data) && count($normalize_data)>0) {
                                   ...
                                   for ($k=0; $k < count($score); $k++) { 
                                    ...
                                    echo CHtml::textField('score'.$i,$score[$i],array('disabled'=>'true','class'=>'form-control score','id'=>'score'.$i,'style'=>'text-align: center','placeholder'=>'score'));
                                }
                                else
                                {
                                    $score = '';
                                     echo CHtml::textField('score'.$i,$score,array('disabled'=>'true','class'=>'form-control score','id'=>'score'.$i,'style'=>'text-align: center','placeholder'=>'score'));
                                }
                                echo CHtml::textField('kra_id'.$i,'',array('disabled'=>'true','class'=>'form-control','id'=>'kra_id'.$i,'style'=>'text-align: center;display:none','placeholder'=>'score'));
                            ...
                            <td>
                                ...
                                if (isset($normalize_data) && count($normalize_data)>0) {
                                   $Score_comment = explode(';',$normalize_data['0']['Score_comment']);
                                    echo CHtml::textField('comment'.$i,$Score_comment[$i],array('disabled'=>'true','class'=>'form-control','id'=>'comment'.$i,'style'=>'text-align: center','placeholder'=>'comment'));
                                }
                                else
                                {
                                    $Score_comment = '';
                                     echo CHtml::textField('comment'.$i,$Score_comment,array('disabled'=>'true','class'=>'form-control','id'=>'comment'.$i,'style'=>'text-align: center','placeholder'=>'comment'));
                                }
                        ...
                        <td>
                            <div class="col-md-7" style="float: right;">
                                ...
                                $cluster_name_models = new ClusterForm();
                                        ...
                                        echo CHtml::activeDropDownList($cluster_name_models,'cluster_name',$list,array('class'=>'form-control promotion','disabled'=>'true','style'=>'width: 204px','options' => $promotion_category));
                            ?>
                            </div>
                        </td>
                    </tr>
...
if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{
 echo CHtml::dropDownList("career_plan",'',$list,$htmlOptions=array('disabled'=>'true','class'=>"form-control career_plan",'style'=>"width: 186px;",'options' => $career_plan,'disabled'=>'true'));
}
else
{
 echo CHtml::dropDownList("career_plan",'',$list,$htmlOptions=array('disabled'=>'true','class'=>"form-control career_plan",'style'=>"width: 186px;",'options' => $career_plan));
}                                       
...
if(isset($settings_data_new['0']['setting_type']) && strtotime(date('Y-m-d'))>strtotime($settings_data_new['0']['setting_type']))
{
 echo CHtml::textArea('career_plan_desc',$career_plan_desc,array('disabled'=>'true','class'=>'form-control','id'=>'career_plan_desc','disabled'=>'true'));
}
else
{
 echo CHtml::textArea('career_plan_desc',$career_plan_desc,array('disabled'=>'true','class'=>'form-control','id'=>'career_plan_desc'));
}
...
{
?>
<textarea id="other_comment"  class="form-control " disabled='true' maxlength="1000" name="employee_review1" disabled="true"  required><?php if(isset($IDP_data) && count($IDP_data)>0 && isset($IDP_data['0']['other_comment'])){ echo $IDP_data['0']['other_comment']; }?></textarea>
<?php
}
else
{
?>
<textarea id="other_comment"  class="form-control " disabled='true' maxlength="1000" name="employee_review1"  required><?php if(isset($IDP_data) && count($IDP_data)>0 && isset($IDP_data['0']['other_comment'])){ echo $IDP_data['0']['other_comment']; }?></textarea>
<?php
}
?>
...
{
?>
<input name="term_condition1" type="checkbox" style="display:none" value="term_condition1"  id="term_condition1"/><lable  style="color: red;display:none" id="blink_me1"> I confirm that the rating given has not been discussed with <?php if(isset($emp_data['0']['Emp_fname'])) { echo $emp_data['0']['Emp_fname']." ".$emp_data['0']['Emp_lname']; } ?>
 </lable>
<br/>

<input name="term_condition" type="checkbox" style="display:none" value="term_condition" id="term_condition"/><lable id="blink_me" style="color: red;display:none"> I have conducted the year end review of  <?php if(isset($emp_data['0']['Emp_fname'])) { echo $emp_data['0']['Emp_fname']." ".$emp_data['0']['Emp_lname']; } ?> on <?php echo  date("d-m-Y");?>
 </lable>
...
{ ?>
                                        <?php echo CHtml::button('Approve',array('class'=>'btn border-blue-soft send_for_appraisal','style'=>'float:right;display:none','id'=>$kpi_data['0']['Employee_id'],'onclick'=>'js:send_notification();')); ?>
                                <?php } ?>
<?php } ?>
