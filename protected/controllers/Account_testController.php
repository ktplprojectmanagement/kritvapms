...
class Account_testController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$this->render('//site/admin_login_demo',array('model'=>$model));
...
//print_r($role_id_array);die();
			//$role_id_array1 = $model->demo_role1($_POST);
			if ($role_id_array != '') {
